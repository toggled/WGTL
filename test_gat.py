...
# Setup GAT Model
model = GAT(nfeat=features.shape[1], nhid=8, heads=8, nclass=int(labels.max())+1, dropout=args.drop_rate, lr=args.lr, weight_decay=args.weight_decay, device=device)
