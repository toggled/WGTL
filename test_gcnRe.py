...
if args.dataset in ['fb100','snap-patents']: # Heterophily dataset:
    ...
    data = CustomDataset(root='/content/drive/MyDrive/WitnesscomplexGNNs/data/'+args.dataset, name=args.dataset, setting='nettack')
...
# s=5
# python test_gcnRe.py --ptb_rate 0 --dataset snap-patents --seed $s --device cuda:1 --lr 0.01 &
# python test_gcnRe.py --ptb_rate 0.05 --dataset snap-patents --seed $s --device cuda:2 --lr 0.01 &
# python test_gcnRe.py --ptb_rate 0.1 --dataset snap-patents --seed $s --device cuda:1 --lr 0.01 &
# python test_gcnRe.py --ptb_rate 0.15 --dataset snap-patents --seed $s --device cuda:2 --lr 0.01 &
# python test_gcnRe.py --ptb_rate 0.2 --dataset snap-patents --seed $s --device cuda:1 --lr 0.01 &
# python test_gcnRe.py --ptb_rate 0.25 --dataset snap-patents --seed $s --device cuda:2 --lr 0.01